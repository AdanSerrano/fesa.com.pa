...
export const adminServicesFiltersSchema = z.object({
...
export const getCategoriesParamsSchema = z.object({
  ...
  sorting: z
    ...
    .optional(),
  filters: adminServicesFiltersSchema.optional(),
});
...
export const updateItemSchema = z.object({
  id: z.string().min(1, "ID de servicio requerido"),
  categoryId: z.string().nullable().optional(),
  name: z.string().min(1, "El nombre es requerido").optional(),
  description: z.string().nullable().optional(),
  image: z.string().nullable().optional(),
...
export type AdminServicesFiltersInput = z.infer<typeof adminServicesFiltersSchema>;
