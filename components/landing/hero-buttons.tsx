  ...
  if (isLoggedIn) {
    return (
      <div className="flex w-full flex-col items-center justify-center gap-4 sm:w-auto sm:flex-row lg:justify-start">
        <Button size="lg" className="h-14 px-8 text-base font-semibold rounded-xl w-full min-w-[200px] sm:w-auto shadow-lg shadow-primary/25 transition-all hover:shadow-xl hover:shadow-primary/30 btn-glow-primary" asChild>
