    ...
    return (
      <div className="flex w-full flex-col items-center justify-center gap-4 sm:w-auto sm:flex-row lg:justify-start">
        <MovingBorder containerClassName="w-full min-w-[200px] sm:w-auto">
          <Button size="lg" className="h-14 px-8 text-base font-semibold rounded-xl w-full shadow-lg shadow-primary/25 transition-all hover:shadow-xl hover:shadow-primary/30" asChild>
