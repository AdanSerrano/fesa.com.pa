...
const CurrencyContent = memo(function CurrencyContent({
  ...
  const displayValue = value.amount === 0 ? "" : value.amount.toFixed(selectedCurrency.decimals ?? 2);
  ...
  return (
    <div className="flex gap-2">
      ...
      <div className="relative flex-1">
        {!showCurrencySelect && (
          <span className="absolute left-3 top-1/2 -translate-y-1/2 text-foreground/60 font-mono z-10 pointer-events-none">
