...
> extends Omit<BaseFormFieldProps<TFieldValues, TName>, "placeholder"> {
  ...
  labels?: {
    frequency?: string;
    interval?: string;
    days?: Record<RecurrenceDayOfWeek, string>;
    ends?: string;
    never?: string;
    onDate?: string;
...
const DAYS_OF_WEEK: RecurrenceDayOfWeek[] = ["SU", "MO", "TU", "WE", "TH", "FR", "SA"];
