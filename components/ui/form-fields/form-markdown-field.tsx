...
const MarkdownPreview = memo(function MarkdownPreview({
  ...
  return (
    <div
      className="prose prose-sm dark:prose-invert max-w-none p-3 overflow-y-auto"
...
>({
  ...
  const handleAction = useCallback(
    (action: MarkdownAction, currentValue: string, onChange: (value: string) => void) => {
              ...
              {showPreview ? (
                <Tabs defaultValue="write" className="w-full">
                  ...
                  <TabsContent value="preview" className="mt-0">
                    <MarkdownPreview content={field.value || ""} minHeight={minHeight} />
                  </TabsContent>
                </Tabs>
              ) : (
                <>
